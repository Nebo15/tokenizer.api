...
#
#     config :gateway_api, Tokenizer.HTTP.Endpoint,
#       ...
...
config :gateway_api, sql_sandbox: {:system, :boolean, "SQL_SANDBOX", false}

#
# Alternatively, you can configure exactly which server to
# start per endpoint:
#
#     config :gateway_api, Tokenizer.HTTP.Endpoint, server: true
#
